<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EmployeesForm.aspx.cs" Inherits="EmployeesApp.EmployeesForm" %>

<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div class="jumbotron">
        <h1>FORM VIEW EMPLOYEES</h1>
        <asp:GridView ID="GridViewEmployees" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#999999" GridLines="None" OnSelectedIndexChanged="GridViewEmployees_SelectedIndexChanged" DataKeyNames="Id">
            <AlternatingRowStyle BackColor="White" ForeColor="#684775" />
            <Columns>
        ...
        <asp:FormView ID="FormViewDetails" runat="server" BackColor="White" BorderColor="#555555" BorderStyle="None" BorderWidth="5px" CellPadding="10" ForeColor="Black" GridLines="Horizontal">
        ...
        <br />
        <asp:Button ID="ButtonBack" runat="server" OnClick="ButtonBack_Click" Text="Back" CssClass="btn btn-warning"/>
        <br />
