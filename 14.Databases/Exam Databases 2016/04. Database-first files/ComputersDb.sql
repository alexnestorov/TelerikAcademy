...
/****** Object:  Database [ComputersDb]    Script Date: 08.11.2016 г. 13:58:09 ч. ******/
CREATE DATABASE [ComputersDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ComputersDb', FILENAME = N'C:\Users\Alexander\ComputersDb.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ComputersDb_log', FILENAME = N'C:\Users\Alexander\ComputersDb_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
